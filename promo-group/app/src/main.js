...
const GlobalConfig = {
    TableMethod: 'crm.promogroup.list',
    CreateMethod: 'crm.promogroup.add',
    UpdateMethod: 'crm.promogroup.change',
    RemoveMethod: 'crm.promogroup.delete'
};
...
const setEditorParamValues = (Row) => {
    ...
    setStoreField('EditorItemBackgroundColorClass', Row.ItemBackgroundColorClass);
    setStoreField('EditorItemTextColorClass', Row.ItemTextColorClass);
    setStoreField('EditorBackgroundColorClass', Row.BackgroundColorClass);
    setStoreField('EditorTextColorClass', Row.TextColorClass);
    setStoreField('EditorIsActive', Row.IsActive == '1' ? true : false);
    setStoreField('EditorIsDeleted', Row.IsDeleted == '1' ? true : false);
};
...
const saveEditor = () => {
    ...
    let Options = {
        ...
        ibcolorcls: State.EditorItemBackgroundColorClass,
        itcolorcls: State.EditorItemTextColorClass,
        bcolorcls: State.EditorBackgroundColorClass,
        tcolorcls: State.EditorTextColorClass,
        active: State.EditorIsActive ? '1' : '0',
        deleted: State.EditorIsDeleted ? '1' : '0'
    };
...
const onRemoveButtonClick = (RowID) => {
    deleteRecord(
        {
            method: GlobalConfig.UpdateMethod,
            id: RowID,
            deleted: '1'
        }
    );
