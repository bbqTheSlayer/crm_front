...
export default class Table extends Component {
    ...
    renderSelectSearch()
    {
        ...
        return (
            <BaseSelect
                ...
                onChange={(Val) => {
                    this.props.setStoreField('FilterFamily', Val)
                }}
            />
        );
    }
    ...
    render()
    {
        const ModelArray = this.props.Store.TableDataSet;
        const SearchName = this.renderSearchInputName();
        const SearchOID = this.renderSearchInputOID();
        const SearchFamily = this.renderSelectSearch();

        const Models = ModelArray.map((Row, i) => {
            ...
            return  (
                <tr key={i}>
                    ...
                    <td className="text-center" value={Row.CarModelFamilyOID}>{Row.FamilyName}</td>
