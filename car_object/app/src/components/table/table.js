...
export default class Table extends Component {
    ...
    render()
    {
        const CarArray = this.props.Store.TableDataSet;
        ...
        const Cars = CarArray.map((Row, i) => {
            return  (
                <tr key={i}>
                    <td className="text-center">{Row.id}</td>
                    <td className="text-center" value={Row.CarModelOID}>{Row.ModelName}</td>
